...
expected_topology = {'Gate':  ['gate', 'Pipe'], 'potentiometer':  ['potentiometer'], 'button':  ['button']}
expected_nodes    = ['Gate', 'potentiometer', 'button']
expected_services = ['gate', 'Pipe', 'potentiometer', 'button']
