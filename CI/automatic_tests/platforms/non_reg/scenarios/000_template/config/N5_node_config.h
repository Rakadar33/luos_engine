...
*******************************************************************************
 *
 * PTP_CONFIG is modified by Luos CI python tool
 *
...
#define PTP_C      GPIO_PIN_4
#define PTP_C_PORT GPIOA
#define PTP_C_IRQ  EXTI4_IRQn
#define PTP_D      GPIO_PIN_2
#define PTP_A_PORT GPIOA
#define PTP_D_IRQ  EXTI2_IRQn


// PTP_CONFIG below is modified by Luos CI python tool :
// #define PTP_CONFIG   // DO NOT EDIT THIS LINE !!!!!!!!!!!!!!!!!!!!!!!

// Depending on previous config values, declaration of PTP lines and RS485 power state 
// -------------------------------------------------------------------------------------
#ifndef PTP_CONFIG
